...
function _MakePWDWidget()
{
	...
	code += "<input stopccp type='password' ng-focus='pwderr=false' ng-blur='pwderr=true' class=' nav-width' placeholder='New Password'  name='"+pwdname+"' id='"+this.pwdfieldid+"' ng-model='pwd' minlength='6' maxlength='32' required equals='{{cnfpwd}}'>";
